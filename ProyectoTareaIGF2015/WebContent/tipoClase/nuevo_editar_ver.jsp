...
<%
	...
	if((esOperacionEditar || esOperacionVer) && id!=""){
		TipoClase tipoClase = ctrlTipoClase.obtenerPorId(id);
		descripcion=tipoClase.getdTipoClase();
		try{
			fechaIngreso=formatter.format(tipoClase.getfIngreso());
		}catch(Exception e){
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- Aqui tiene que ir el contenido -->
                        ...
                        <div class="pull-right"><a href="<%=context_path %>/tipoClase/lista.jsp">
                        <button class="btn btn-primary">Regresar a Listado</button></a></div>
                        <form class="form-horizontal" action="<%=context_path %>/tipoClase/operaciones.jsp" method="post">
                        <input type="text" id="operacion" name="operacion" value="<%=operacion %>" class="hidden">
                        <fieldset>

                        <!-- Form Name -->
                        <legend>Nuevo tipo de Clase</legend>
