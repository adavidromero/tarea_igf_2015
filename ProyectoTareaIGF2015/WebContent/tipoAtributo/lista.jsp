            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- Aqui tiene que ir el contenido -->
                        <h1>Tipos Atributos </h1>
                        <div class="pull-right"><a href="<%=context_path %>/tipoAtributo/nuevo_editar_ver.jsp?operacion=crear">
    					...
    					List tiposAtributos = ctrlTipoAtributo.obtenerTodosTiposAtributos();
						SimpleDateFormat formatter = new SimpleDateFormat("dd MMM yyyy");
						String strFechaIngreso="";
						int length=tiposAtributos.size();
    					for(int i=0;i<length;i++){
    						TipoAtributo tipoAtributo=(TipoAtributo)tiposAtributos.get(i);
    						try{
    							strFechaIngreso=formatter.format(tipoAtributo.getfIngreso());
    						}catch(Exception e){
    							System.out.println(e.getStackTrace());
    						}
                        %>
                        	<tr>
                        	<td><%=tipoAtributo.getcTipoAtributo() %></td>
                        	<td><%=tipoAtributo.getdTipoAtributo() %></td>
                        	<td><%=strFechaIngreso %></td>
                        	<td>
                        	<a href="<%=context_path %>/tipoAtributo/nuevo_editar_ver.jsp?operacion=ver&id=<%=tipoAtributo.getcTipoAtributo() %>">
                        	<span class="glyphicon glyphicon-eye-open"></span></a>
                        	<a href="<%=context_path %>/tipoAtributo/nuevo_editar_ver.jsp?operacion=editar&id=<%=tipoAtributo.getcTipoAtributo() %>">
                        	<span class="glyphicon glyphicon-pencil"></span></a>
							<a class="eliminar" data-codigo="<%=tipoAtributo.getcTipoAtributo() %>" 
                        		data-descripcion=<%=tipoAtributo.getdTipoAtributo() %>
                        	href="#">
