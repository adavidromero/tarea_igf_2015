...
<%
	...
	if((esOperacionEditar || esOperacionVer) && id!=""){
		TipoAtributo tipoAtributo = ctrlTipoAtributo.obtenerPorId(id);
		descripcion=tipoAtributo.getdTipoAtributo();
		try{
			fechaIngreso=formatter.format(tipoAtributo.getfIngreso());
		}catch(Exception e){
